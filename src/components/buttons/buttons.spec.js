describe('material-button', function() {
  ...
  it('should have inner-anchor with attrs if href attr is given', inject(function($compile, $rootScope) {
    ...
    var button = $compile('<material-button href="/link" rel="foo" target="bar" something="baz">' +
                            '<div>content</div>' +
  ...
  it('should have inner-anchor with attrs if ng-href attr is given', inject(function($compile, $rootScope) {
    ...
    var button = $compile('<material-button ng-href="/link" rel="foo" target="bar" something="baz">' +
                            '<div>content</div>' +
                          '</material-button>')($rootScope);
  ...
  it('should have inner-button with attrs by default', inject(function($compile, $rootScope) {
    ...
    var button = $compile('<material-button type="foo" ng-disabled="true" form="bar">' +
                            '<div>content</div>' +
                          '</material-button>')($rootScope);
